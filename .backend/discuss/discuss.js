...
(function(){
  ...
  (function(it){
    ...
    return function(it){
      ...
      return api.post('/discuss/', aux.signedin, throttle.kit.generic, backend.middleware.captcha, function(req, res){
        var lc;
        lc = {};
        return Promise.resolve().then(function(){
          ...
          lc.slug = suuid();
          return db.query("insert into discuss (slug, uri, title) values ($1,$2,$3) returning key", [lc.slug, lc.uri, lc.title || '']);
        }).then(function(r){
          r == null && (r = {});
